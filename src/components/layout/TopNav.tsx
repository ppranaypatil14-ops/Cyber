...
export function TopNav() {
  return (
    <header className="h-16 bg-cyber-darker border-b border-cyber-card flex items-center justify-between px-6 sticky top-0 z-10">
      ...
      <div className="flex-1 max-w-xl">
        <div className="relative">
          ...
          <input 
            ...
            className="w-full bg-cyber-dark border border-cyber-card rounded-md pl-10 pr-4 py-2 text-sm text-slate-200 focus:outline-none focus:border-cyber-cyan transition-colors"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        {/* Notifications */}
        <button className="relative p-2 text-slate-400 hover:text-white transition-colors rounded-full hover:bg-cyber-card">
          <Bell className="w-5 h-5" />
          <span className="absolute top-1 right-1 w-2.5 h-2.5 bg-status-critical rounded-full border border-cyber-darker"></span>
        </button>
